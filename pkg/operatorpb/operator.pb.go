...
const file_operator_proto_rawDesc = "" +
	"\n" +
	"\x0eoperator.proto\x12\x02pb\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf4\x03\n" +
	"\bOperator\x12\x1f\n" +
	"\voperator_id\x18\x01 \x01(\x03R\n" +
	"operatorId\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x1b\n" +
	"\tfull_name\x18\x03 \x01(\tR\bfullName\x12\x14\n" +
	"\x05email\x18\x04 \x01(\tR\x05email\x12O\n" +
	"\x13password_changed_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampH\x00R\x11passwordChangedAt\x88\x01\x01\x12\x1c\n" +
	"\x04role\x18\x06 \x01(\v2\b.pb.RoleR\x04role\x12'\n" +
	"\x0fhashed_password\x18\a \x01(\tR\x0ehashedPassword\x129\n" +
	"\n" +
	"created_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12\x16\n" +
	"\x06status\x18\t \x01(\tR\x06status\x12&\n" +
	"\x0fis_first_access\x18\n" +
	" \x01(\bR\risFirstAccess\x12*\n" +
	"\x11is_email_verified\x18\v \x01(\bR\x0fisEmailVerified\x12!\n" +
	"\fphone_number\x18\f \x01(\tR\vphoneNumberB\x16\n" +
	"\x14_password_changed_at\"\xce\x01\n" +
	"\x04Role\x12\x17\n" +
	"\arole_id\x18\x01 \x01(\x03R\x06roleId\x12\x19\n" +
	"\x05admin\x18\x02 \x01(\x05H\x00R\x05admin\x88\x01\x01\x12\x1f\n" +
	"\boperator\x18\x03 \x01(\x05H\x01R\boperator\x88\x01\x01\x12\x17\n" +
	"\x04post\x18\x04 \x01(\x05H\x02R\x04post\x88\x01\x01\x12'\n" +
	"\fnotification\x18\x05 \x01(\x05H\x03R\fnotification\x88\x01\x01B\b\n" +
	"\x06_adminB\v\n" +
	"\t_operatorB\a\n" +
	"\x05_postB\x0f\n" +
	"\r_notification\"\xcf\x03\n" +
	"\fOperatorList\x12\x1f\n" +
	"\voperator_id\x18\x01 \x01(\x03R\n" +
	"operatorId\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x1b\n" +
	"\tfull_name\x18\x03 \x01(\tR\bfullName\x12\x14\n" +
	"\x05email\x18\x04 \x01(\tR\x05email\x12O\n" +
	"\x13password_changed_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampH\x00R\x11passwordChangedAt\x88\x01\x01\x129\n" +
	"\n" +
	"created_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12&\n" +
	"\x0fis_first_access\x18\a \x01(\bR\risFirstAccess\x12*\n" +
	"\x11is_email_verified\x18\b \x01(\bR\x0fisEmailVerified\x12\x16\n" +
	"\x06status\x18\t \x01(\tR\x06status\x12\x1c\n" +
	"\x04role\x18\n" +
	" \x01(\v2\b.pb.RoleR\x04role\x12!\n" +
	"\fphone_number\x18\v \x01(\tR\vphoneNumberB\x16\n" +
	"\x14_password_changed_atB(Z&github.com/dinhtatuanlinh/source_protob\x06proto3"
