...
var file_operator_proto_rawDesc = string([]byte{
	...
	0x0d, 0x5f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x28,
...
var file_operator_proto_depIdxs = []int32{
	2, // 0: pb.Operator.password_changed_at:type_name -> google.protobuf.Timestamp
	1, // 1: pb.Operator.role:type_name -> pb.Role
	2, // 2: pb.Operator.created_at:type_name -> google.protobuf.Timestamp
